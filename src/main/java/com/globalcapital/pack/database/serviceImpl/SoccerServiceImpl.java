...
import com.globalcapital.pack.database.entity.Team;
import com.globalcapital.pack.database.repository.GenericRepository;
import com.globalcapital.pack.database.repository.PlayerRepository;
import com.globalcapital.pack.database.repository.TeamRepository;
import com.globalcapital.pack.database.serviceInterface.SoccerService;
...
public class SoccerServiceImpl implements SoccerService {
	...
	public void addBarcelonaPlayer(String name, String position, int number) {
		Long seq = (long) 1;
		Team barcelona = teamRepository.findOne((long) 2);
	...
	@Override
	public void getSpecificPlayerByID(int id) {
		
		Player newPlayer = new Player();
		newPlayer = playerRepository.findUserByID(id);
	...
	@Override
	public List<Object[]> getMultipleTbales() {
