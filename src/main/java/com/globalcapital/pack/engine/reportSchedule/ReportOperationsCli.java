 ...
 */
package com.globalcapital.pack.engine.reportSchedule;
...
public class ReportOperationsCli {
	
	public ReportOperationsCli() {
	}
	...
	public int startReportCli(String command) throws IOException {
		int counter = 0;
		...
		while (counter <= 0) {
			if ((checkDBBackgroundActivity() == true)) {
				...
				System.out.println("Report process has started");
