...
public class ReschedulingBatchRunOne implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			+ " -parameters String:RESCHEDULING_DATE="+DateUtility.fourteenthOfMonth() + " -u"+ batchBean.getUsername() +" -p " + batchBean.getPassword() + " -jndi.url\r\n "
			...
			System.out.println("~~~~~~~~~~~~ ReschedulingBatchRunOne batch completed~~~~~~~~~~"+DateUtility.DateNowToString());
