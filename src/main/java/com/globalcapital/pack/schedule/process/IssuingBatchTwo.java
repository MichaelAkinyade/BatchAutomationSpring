...
public class IssuingBatchTwo implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			+ " -parameters String:ISSUING_DATE="+DateUtility.lastDayOfTheMonth()+ " -u"+ batchBean.getUsername() +" -p " + batchBean.getPassword() + " -jndi.url\r\n "
			...
			System.out.println("~~~~~~~~~~~~ Issuing run 2 batch completed~~~~~~~~~~"+DateUtility.DateNowToString());
