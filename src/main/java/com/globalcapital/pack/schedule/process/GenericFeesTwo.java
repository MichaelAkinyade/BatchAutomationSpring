	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			String command = batchBean.getPath() + " batch:start -batchType " + batchBean.getBatchType()
					+ " -parameters String:Calculation_Date="+DateUtility.fifteenthDayOfMonthReduceMonthByOneString() + " -batchConfig Integer:maxBusinessError=25  -u"+ batchBean.getUsername() +" -p " + batchBean.getPassword() + " -jndi.url\r\n "
