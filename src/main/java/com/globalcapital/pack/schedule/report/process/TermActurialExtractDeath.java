...
public class TermActurialExtractDeath implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			reportBean.setReportName("TERM_ACTUARIAL_EXTRACT_DEATH");
			reportBean.setReportJobId("termActurialExtractDeath");
			...
			reportOperationCli.startReportCli(command, reportBean.getPath(), "termActurialExtractDeath");
			H2DatabaseLuncher.executeStatementInsertAndTruncate(
					"INSERT INTO REPORT_AUDIT (ID, REPORT_ID, LAST_RUN_DATE, NEXT_SCHEDULE_DATE, REPORT_SUCCESSFUL, REPORT_FAILED, REPORT_STARTTIME, REPORT_ENDTIME) VALUES (report_seq.nextval,'"
							+ ScheduleConstantClass.termActurialExtractDeath + "','"
