...
public class Policybeneficiaries  implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			reportBean.setReportName("POLICY_BENEFICIARIES");
			reportBean.setReportJobId("policyBeneficiaries");
			...
			reportOperationCli.startReportCli(command, reportBean.getPath(),"POLICY_BENEFICIARIES");
			H2DatabaseLuncher.executeStatementInsertAndTruncate(
					"INSERT INTO REPORT_AUDIT (ID, REPORT_ID, LAST_RUN_DATE, NEXT_SCHEDULE_DATE, REPORT_SUCCESSFUL, REPORT_FAILED, REPORT_STARTTIME, REPORT_ENDTIME) VALUES (report_seq.nextval,'"
							+ ScheduleConstantClass.policyBeneficiaries + "','"
