...
public class ThirdPartyActiveAddress  implements Job {
	...
	public void execute(JobExecutionContext context) {
		...
		try {
			...
			reportBean.setReportName("THIRD_PARTY_ACTIVE_ADDRESS");
			reportBean.setReportJobId("thirdPartyActiveAddress");
			...
			reportOperationCli.startReportCli(command, reportBean.getPath(),"thirdPartyActiveAddress");
			H2DatabaseLuncher.executeStatementInsertAndTruncate(
					"INSERT INTO REPORT_AUDIT (ID, REPORT_ID, LAST_RUN_DATE, NEXT_SCHEDULE_DATE, REPORT_SUCCESSFUL, REPORT_FAILED, REPORT_STARTTIME, REPORT_ENDTIME) VALUES (report_seq.nextval,'"
							+ ScheduleConstantClass.thirdPartyActiveAddress + "','"
